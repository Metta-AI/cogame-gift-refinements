(function () {
  ...
  function createCore(config) {
    ...
    function start() {
      ...
      try {
        worker = new Worker(workerUrl, { name: 'gift-refinements-static-replay' });
  ...
  // The page detects the static bundle by this global, so the name is part of
  // the inherited chrome's contract and is NOT renamed.
