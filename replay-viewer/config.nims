...
# use-after-free fixed in gift_refinements_replay.nim (emscripten_exit_with_live_runtime)
...
# gr_error_len(). Aborting keeps linear memory intact, and the page reads
# gr_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "gift_refinements_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_gr_load_replay,_gr_frame,_gr_input,_gr_packet_ptr,_gr_packet_len,_gr_error_ptr,_gr_error_len,_gr_stage_ptr,_gr_stage_len
  """).replace("\n", " ")
)
