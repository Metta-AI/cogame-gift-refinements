...
# Substitute: gift-refinements, coworld-gift-refinements, 6.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-gift-refinements:ci)
#   SMOKE_SLUG                 game slug                        (gift-refinements)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/gift-refinements)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/gift-refinements-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-gift-refinements:ci}}"
slug="${SMOKE_SLUG:-gift-refinements}"
